...
Node.js 22+, TypeScript, SQLite (`better-sqlite3`), FTS5, LanceDB, imapflow. Dev: `tsx`; install: `curl -fsSL https://raw.githubusercontent.com/cirne/zmail/main/install.sh | bash` (or build: `npm run build` → `dist/index.js`).
