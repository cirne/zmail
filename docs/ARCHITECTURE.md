...
**Decision:** TypeScript on Node.js 22+. Dev: `tsx` runs source directly; distribution: `tsc` + `tsc-alias` → `dist/`, install via `npm i -g @cirne/zmail` from GitHub Packages (see [OPP-007](opportunities/OPP-007-packaging-npm-homebrew.md)).
