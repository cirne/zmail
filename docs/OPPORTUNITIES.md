...
| [OPP-007](opportunities/archive/OPP-007-packaging-npm-homebrew.md) | Packaging and Distribution — npm, Homebrew | Node.js 22+ runtime; install via `npm i -g zmail`; dev uses `tsx`. Binary dropped; distribution is npm-only. |
